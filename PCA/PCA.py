# -*- coding: utf-8 -*-
"""
Created on Sun Mar  1 14:39:37 2020
...
#Standard Scaler = (x-u)/s, s: st dev, x: values, u: mean
...
finalDf = pd.concat([principalDf, df[['target']]], axis = 1) # axis = 0 --> row & axix = 1 --> column
